...
Description: Elementor Demo Element
Version: 1.0
Author: Shamim
...
namespace TimerElementExtension;

use Elementor_Timer_Widget;
...
final class TimerElementExtension {
    ...
    function frontend_assets_scripts() {
        ...
        wp_enqueue_script("timerelement-helper-js", plugins_url("/assets/js/script.js", __FILE__), array('jquery', 'flipclock-js'), time(), true);
    }
    ...
    public function register_new_category($manager) {
        $manager->add_category('timer', [
            'title' => __('Element Timer', 'timerelement'),
            'icon'  => 'eicon-custom'
        ]);
    }
